...
void GameFinal::ResetRound()
{
	...
	m_player1 = std::make_unique<Player>(Colours::RED,m_enabledElemental,m_enabledMage);
	m_player2 = std::make_unique<Player>(Colours::BLUE, m_enabledElemental, m_enabledMage);
